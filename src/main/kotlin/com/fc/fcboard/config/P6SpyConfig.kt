...
class P6SpyConfig : JdbcEventListener(), MessageFormattingStrategy {
    ...
    override fun formatMessage(
        ...
        val message = basicInfo(now, elapsed, category, connectionId, url, prepared)
    ...
    private fun milliSecondToDateTime(now: String): String {
        val simpleDateFormat = SimpleDateFormat(DATE_TIME_FORMAT, Locale.KOREA)
